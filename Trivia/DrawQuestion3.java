 ...
 * @version 2018-04-21
 */
public class DrawQuestion3 extends JPanel
{
    ...
    public DrawQuestion3(String username){
        this.username = username;
        input_file();
    }
    
    public void input_file(){
        File file = new File("Trivia3.txt");
        Scanner in;
        try{
            in = new Scanner(file);
            String str;
    ...
    public static void main(String[] args){
        ...
        DrawQuestion3 question = new DrawQuestion3("User");
