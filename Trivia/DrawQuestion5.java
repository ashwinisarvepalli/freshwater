 ...
 * @version 2018-04-21
 */
public class DrawQuestion5 extends JPanel
{
    ...
    public DrawQuestion5(String username){
        this.username = username;
        input_file();
    }
    
    public void input_file(){
        File file = new File("Trivia5.txt");
        Scanner in;
        try{
            in = new Scanner(file);
            String str;
    ...
    public static void main(String[] args){
        ...
        DrawQuestion5 question = new DrawQuestion5("User");
