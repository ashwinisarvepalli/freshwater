 ...
 * @version 2018-04-21
 */
public class DrawQuestion4 extends JPanel
{
    ...
    public DrawQuestion4(String username){
        this.username = username;
        input_file();
    }
    
    public void input_file(){
        File file = new File("Trivia4.txt");
        Scanner in;
        try{
            in = new Scanner(file);
            String str;
    ...
    public static void main(String[] args){
        ...
        DrawQuestion4 question = new DrawQuestion4("User");
