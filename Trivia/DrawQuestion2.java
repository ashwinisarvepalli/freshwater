 ...
 * @version 2018-04-21
 */
public class DrawQuestion2 extends JPanel
{
    ...
    public DrawQuestion2(String username){
        this.username = username;
        input_file();
    }
    
    public void input_file(){
        File file = new File("Trivia2.txt");
        Scanner in;
        try{
            in = new Scanner(file);
            String str;
    ...
    public static void main(String[] args){
        ...
        DrawQuestion2 question = new DrawQuestion2("User");
